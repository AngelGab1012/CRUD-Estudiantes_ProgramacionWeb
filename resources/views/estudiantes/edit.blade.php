...
@section('contenido')
     <div class="m-20">
        ...
        font-extrabold tracking-wider">
            Editar Estudiante:<br>{{ $estudiante->nombre }}
        </h2>

        <form class="flex flex-col items-center my-15 mx-60 rounded-2xl p-5 shadow-2xl shadow-[#3F72AF]/50"
        method="POST" action="{{ route('estudiante.update', $estudiante->id) }}">
            ...
            <div class="flex items-center justify-between w-full mb-10">
                ...
                type="text" name="nombre" placeholder="Ej. Sebastian Esau Gaytan Lopez" value="{{ $estudiante->nombre }}">
            ...
            <div class="flex items-center justify-between w-full mb-10">
                ...
                type="text" name="email" placeholder="Ej. mango@frutas.com" value="{{ $estudiante->email }}">
            ...
            <div class="flex items-center justify-between w-full mb-10">
                ...
                <div>
                    ...
                    font-semibold focus:outline-3 focus:outline-offset-2 focus:outline-[#3F72AF]
                    @error('id_carrera') focus:outline-red-400 bg-red-200 @enderror"
                    name="carrera" id="carrera">

                        <option value="">Selecciona una carrera</option>
                        @foreach($carreras as $carrera)
                        
                        <option value="{{ $carrera->id }}" {{ $estudiante->id_carrera == $carrera->id ? 'selected' : '' }}>
                            {{ $carrera->nombre }}
                        </option>
            ...
            <div class="flex items-center justify-between w-full mb-15">
                ...
                type="text" name="semestre" placeholder="Ej. 6" value="{{ $estudiante->semestre }}">
