                ...
                <tr>
                    ...
                    <td class="border-3 border-[#E38B29] p-4">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('carrera.edit', $carrera->id) }}" title="Editar" 
                            ...
                            <button onclick="confirmDelete({{ $carrera->id }})" title="Eliminar" 
                            ...
                            <form method="POST" action="{{ route('carrera.delete', $carrera->id) }}" 
                            id="delete-carrera-{{ $carrera->id }}">
                                @csrf
                                @method('DELETE')
                            </form>
                        </div>
        ...
        function confirmDelete(id){
            ...
            Swal.fire({
                ...
                if(result.isConfirmed){
                    document.getElementById('delete-carrera-'+id).submit();
                }
